...
@section('main')
    ...
    <div class="w-full max-w-xs mx-auto mt-44">
        ...
        <form class="bg-white shadow-md rounded border .border-customgreen px-8 pt-6 pb-8 mb-4" action="{{ route('productstates.store') }}" method="POST">
            @csrf
            <div class="mb-4">
